# Generated by Django 2.0.1 on 2018-02-22 01:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='genomic_profiles.GenomicProfile')),
            ],
        ),
        migrations.CreateModel(
            name='Pathogenicity',
            fields=[
                ...
                ('oncotatoroutput', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='pathogenicity.OncotatorOutput')),
            ],
        ),
    ]
