# Generated by Django 2.0.1 on 2018-03-06 21:43
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('genomicprofile', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='genomic_profiles.GenomicProfile')),
        ...
        migrations.CreateModel(
            name='Pathogenicity',
            fields=[
                ('oncotatoroutput', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='pathogenicity.OncotatorOutput')),
